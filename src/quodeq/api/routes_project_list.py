...
_EMPTY_ESTIMATES_PAYLOAD = {
    "dimensions": {}, "projectFiles": 0, "cachedFiles": 0, "changedFiles": 0,
}


def _project_estimates_payload(
    ...
    """
    from quodeq._cli_resolution import _filter_manifest_by_scope
    ...
    try:
        ...
        return dict(_EMPTY_ESTIMATES_PAYLOAD)
...
def register_project_list_routes(app: Flask, provider: ActionProvider) -> None:
    ...
    def project_estimates(project: str) -> Response | tuple[Response, int]:
        ...
        return jsonify(_project_estimates_payload(project_dir, requested, clean_scan))
