...
class FindingSpec:
    ...
    # The input carrier declares the Finding fields it fills, under the same
    # names, so this block repeats core/types/finding.py by design.
    # jscpd:ignore-start
    file: str | None = None
...
def build_finding_base(spec: FindingSpec) -> Finding:
    ...
    return Finding(
        ...
        scope_downgrade=spec.scope_downgrade,
