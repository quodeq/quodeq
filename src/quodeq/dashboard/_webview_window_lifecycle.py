...
from quodeq.dashboard._webview_window_about import set_macos_app_identity
from quodeq.dashboard._webview_window_chrome import (
    logger,
    set_macos_titlebar_appearance,
    set_macos_unified_toolbar,
...
def _run_macos_loaded_hooks(window: object) -> None:
    ...
    """
    show_macos_traffic_lights(window)
    set_macos_unified_toolbar(window)
    set_macos_titlebar_appearance(window, True)
    ...
    install_macos_fullscreen_observer(window)
