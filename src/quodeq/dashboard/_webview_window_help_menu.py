...
Leaf module for _webview_window.py. NAVIGATE_HELP_JS and non_macos_menu are
...
NAVIGATE_HELP_JS = "window.dispatchEvent(new CustomEvent('quodeq:navigate', { detail: 'help' }))"
...
def install_macos_help_menu(window: object) -> None:
