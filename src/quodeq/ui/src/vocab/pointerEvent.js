...
// window pointermove during the gesture, pointerup (or pointercancel) to end it. Shared across
...
export const POINTER_EVENT = Object.freeze({ MOVE: 'pointermove', UP: 'pointerup', CANCEL: 'pointercancel' });
