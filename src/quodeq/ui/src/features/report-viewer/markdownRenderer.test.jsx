...
describe('ReportMarkdown', () => {
  it('renders headings inside the report-pane-md scope', () => {
    const { container } = render(<ReportMarkdown markdown={"# Title\n\n## Subtitle"} />);
  ...
  it('opens links in a new tab with safe rel attributes', () => {
    const { container } = render(<ReportMarkdown markdown="[a](https://example.com)" />);
  ...
  it('renders empty markdown as the empty-state message', () => {
    const { container } = render(<ReportMarkdown markdown="" />);
