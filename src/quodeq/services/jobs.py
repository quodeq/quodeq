...
class JobManager(JobMonitorMixin, JobCapacityMixin):
    ...
    def __init__(
        ...
        *, log: LogSink = NULL_LOG,
        ...
        # watchdog tick. Allowed observable delta (see the plan): a test or
        # caller that mutates WATCHDOG_DEADLINE_GRACE_S after this manager
        # is built no longer changes its behavior; mutate it before
