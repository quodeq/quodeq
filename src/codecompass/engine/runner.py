...
from codecompass.engine.evidence_parser import parse_jsonl_to_evidence
from codecompass.engine.plugin_loader import load_plugin_full
from codecompass.engine.prompt_builder import build_analysis_prompt, load_template
...
def run_full(config: RunConfig, output_dir: Path, mode: str = "numerical") -> dict:
    ...
    from codecompass.engine.report import write_dimension_report
