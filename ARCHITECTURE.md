...
|------|-------|----------|------------|
| `tools/check_sizes.py` via `tests/tools/test_size_limits.py` | files <= 300 lines (`src/quodeq`, `tests`, `ui/src`), functions <= 60 lines (`src/quodeq`); vendored/generated dirs excluded | `tools/size_baseline.txt` | `python tools/check_sizes.py --update-baseline` |
| `tools/check_params.py` via `tests/tools/test_param_limits.py` | functions <= 6 parameters, self/cls excluded (`src/quodeq`); vendored/generated dirs excluded | `tools/param_baseline.txt` | `python tools/check_params.py --update-baseline` |
