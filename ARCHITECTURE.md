...
| `tools/check_params.py` via `tests/tools/test_param_limits.py` | functions <= 5 parameters, self/cls excluded (`src/quodeq`, `tools`); vendored/generated dirs excluded | `tools/param_baseline.txt` | `python tools/check_params.py --update-baseline` |
...
| `npm run lint:hygiene` | unused bindings, functions <= 5 parameters | `ui/tools/hygiene_baseline.json` | `npm run lint:hygiene:update` |
