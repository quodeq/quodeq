...
## Related: Incremental Analysis (separate branch)

The incremental analysis feature (diff-based re-evaluation, per-dimension fingerprinting, findings carry-forward) is designed in a separate spec: `docs/superpowers/specs/2026-03-22-incremental-analysis-design.md`. It depends on the import graph infrastructure from Feature 1 (Layer 3) and will be implemented after this branch lands.
