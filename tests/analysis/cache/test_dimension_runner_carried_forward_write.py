...
def _replay(consolidated: list[dict], unconsolidated: list[dict] | None = None) -> ClassifyResult:
    return ClassifyResult(
        cached_findings=consolidated, unconsolidated_findings=list(unconsolidated or []),
    )
