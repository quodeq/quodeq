from quodeq.assistant.adapters.api import ApiTurnConfig, run_api_turn
from tests._timeouts import budget

from ._api_adapter_helpers import (
    ClosableFakeClient, FakeClient, _config, _delta, _session, _tool_call_delta,
)
