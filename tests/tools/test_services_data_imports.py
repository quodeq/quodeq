...
_BASELINE = frozenset({
    ...
    "_evaluations_index.py:quodeq.data.sqlite",
    "_evaluations_index.py:quodeq.data.sqlite.index_sync",
    ...
    "_run_index_fs.py:quodeq.data.sqlite",
    "_run_status_readers.py:quodeq.data.fs.dimensions_state_store",
    "_run_status_readers.py:quodeq.data.sqlite",
    "_scan_progress_dims.py:quodeq.data.fs.evidence_tally",
    "_scan_progress_dims.py:quodeq.data.fs.standards_loader",
    ...
    "dashboard_trend.py:quodeq.data.fs.report_parser.grades",
    "dashboard_trend.py:quodeq.data.fs.report_parser.runs",
    "evidence_rescore.py:quodeq.data.fs.standards_loader",
    ...
    "rescore.py:quodeq.data.fs.report_parser.grades",
    "run_events.py:quodeq.data.events.reader",
    "run_keys.py:quodeq.data.sqlite.findings_queries",
    "run_reports.py:quodeq.data.fs.report_parser.runs",
    "runs_unit.py:quodeq.data.fs.report_parser.grades",
    "runs_unit.py:quodeq.data.fs.report_parser.runs",
    "runs_unit.py:quodeq.data.sqlite.run_index",
    "scan_progress.py:quodeq.data.fs.dimensions_state_store",
    "score_run.py:quodeq.data.fs.standards_loader",
    "scoring/_summary.py:quodeq.data.fs.report_parser.grades",
    ...
    "violations.py:quodeq.data.fs.report_parser",
    "violations.py:quodeq.data.fs.standards_loader",
})
