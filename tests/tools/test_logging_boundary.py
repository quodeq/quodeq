...
DECLARED_LOGGING_SITES: dict[str, str] = {
    ...
    'analysis/subagents/runner.py': 'Subagent processing path - runs a dimension via N parallel subagents - out of scope for this sweep (not a flagged per-site conversion)',
