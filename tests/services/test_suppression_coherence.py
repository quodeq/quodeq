...
- the evidence-based rescore and its excluded-findings count (services/evidence_rescore),
...
from quodeq.services.evidence_rescore import (
    ...
    rescore_dimension_from_evidence,
...
def test_one_dismiss_every_surface_agrees(tmp_path, monkeypatch):
    ...
    # 2. The rescore's own excluded count agrees: exactly this one finding.
