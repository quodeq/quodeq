"""Tests for v2 runner (full pipeline orchestration)."""
...
from codecompass.v2.engine.runner import run, run_full, RunConfig, _merge_evidence
...
class TestRun:
    ...
    @patch("codecompass.v2.engine.runner.run_analysis")
